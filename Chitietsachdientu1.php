...
<section class="e-book-detail mt-6">
    ...
    <div class="container">
        ...
        <div class="flex flex-col lg:flex-row gap-x-6 gap-y-6">
            ...
            <div class="mx-auto w-[300px] xl:w-[370px]">
                ...
                <div class="mt-3 w-full img__w-full rounded-[0.625rem] shadow-[0px_4px_10px_rgba(0,0,0,0.12)]">
            ...
            <div class="lg:w-[calc(100%-300px)] xl:w-[calc(100%-370px)] space-y-4">
                ...
                <div class="bg-white p-4 rounded-[0.625rem] shadow-[0_0_15px_rgba(0,0,0,0.25)] space-y-4">
                    ...
                    <div class="flex flex-wrap gap-y-2 items-center  module-tabs module-tabs-book text-[0.875rem]">
                        ...
                        <form id="" for="" class=" p-[2px] rounded-full md:bg-[#efefef] flex gap-x-2 gap-y-2 flex-wrap">
                    ...
                    <div class="flex flex-wrap gap-y-2 justify-between">
                        ...
                        <div class="flex flex-wrap gap-2 font-nunito font-semibold">
                            ...
                            <a href="" title=""
                                ...
                                class="font-nunito font-semibold btn-book-proofread flex bg-color-v3 border border-color-v3 hover:bg-white hover:text-color-v3  items-center justify-center px-4 py-1 text-white rounded-[0.3125rem]">
                            ...
                            <a href="" title=""
                                ...
                                class="font-nunito font-semibold py-[0.5625rem] px-[2.75rem] text-white border border-color-v2 bg-color-v2 hover:bg-white hover:text-color-v2 rounded-[0.3125rem]">
                            ...
                            <button
                                ...
                                class="font-nunito font-semibold py-[0.5625rem] px-[1.875rem] text-color-v2 border border-color-v2 bg-white hover:bg-color-v2 hover:text-white rounded-[0.3125rem]">
                ...
                <div
                    ...
                    <?php $list_paper_book = ['Giới thiệu', 'Đánh giá và nhận xét'];
