    ...
    <div class="container">
        <div class="flex flex-wrap">
            ...
            <div class="w-full lg:w-[calc(100%-292px)]">
                ...
                <div class="bg-white rounded-[0.625rem] p-4 border border-[#95b3d6] swiper-course-outstanding mb-6">
                    <div class="sm:flex gap-x-4 mb-4">
                        <span class="mr-auto text-[1.5rem] font-semibold text-color-v1">Nổi bật</span>
                        <div class="hidden md:flex items-center">
                            <div class="swiper-pagination-progressbar-course relative !w-[16.125rem] mr-3"></div>
                            <div class="swiper-course-outstanding-prev mr-1">
                            ...
                            <div class="swiper-course-outstanding-next">
                        ...
                        <div class="swiper-wrapper">
                            <?php for ($i = 0; $i < 12; $i++) { ?>
                                <div class="swiper-slide">
                                    <?php $key = 2;
                                    @include('template/course/item.php');
                                    ?>
                                </div>
                            <?php } ?>
                        </div>
                        <div class="w-full text-center md:hidden mt-4">
                            <div class="swiper-pagination-bullets-course"></div>
                        </div>
                    </div>
                </div>
                <div class="bg-white rounded-[0.625rem] p-4 border border-[#95b3d6] swiper-course-outstanding">
                    <div class="sm:flex gap-x-4 mb-4">
                ...
                <div class="module-tabs mb-4">
                    <?php $list_doc = ['Tất cả', 'Khóa học nổi bật', 'Top 10 Khóa học mua nhiều', 'Khóa miễn phí']; ?>
                        ...
                        <?php foreach ($list_doc as $key => $item) { ?>
                            <div class="tab-content <?php echo $key == 0 ? 'active' : ''; ?>"
                                ...
                                <div class="flex flex-wrap -mx-3 -mb-8">
                                    <?php for ($i = 0; $i < 15; $i++) { ?>
                                        <div class="w-full md:w-1/2 xl:w-1/3 px-3 mb-8">
                                ...
                                <?php for ($i = 0; $i < 10; $i++) { ?>
                                    <div class="swiper-slide">
                                        <div class="text-center p-4 relative before:absolute before:inset-x-0 before:-z-[1] z-[1] before:bottom-0 before:rounded-[10px] before:h-[calc(100%-5rem)] before:border before:border-color-v5">
                                            ...
                                            <span class="text-black text-[0.875rem] mb-4 block">Chuyên gia tư vấn</span>
