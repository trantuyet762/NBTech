                                            ...
                                            <div class="flex items-center gap-2">
                                                ...
                                                <div class="flex justify-between items-center">
                                                    ...
                                                    <div class="mr-5 xl:mr-14">
                                                        ...
                                                        <p class="line-clamp-2 text-[0.875rem] ">
                                                    ...
                                                    <span class="text-[0.875rem] font-semibold mr-2 ">
                ...
                <div class="lg:sticky md:top-20  space-y-6">
                    ...
                    <div
                        ...
                        <a href="" title=""
                            ...
                            class="cursor-pointer block  w-full border border-[#0F9408] bg-[#0f9408] text-white p-4 text-center rounded-[5px] hover:text-[#0F9408] hover:bg-white text-[1.125rem] font-semibold font-nunito uppercase ">
